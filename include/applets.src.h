...
IF_EVSSLGETCERT(APPLET(evsslgetcert, BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
IF_RPTRA6(APPLET(rptra6, _BB_DIR_BIN, _BB_SUID_NEVER))
IF_RPTADDR6(APPLET(rptaddr6, _BB_DIR_BIN, _BB_SUID_NEVER))
